...
const ALL_18_HOLES = [
  ...
  { name: 'Hole 16: Triple Windmill Gauntlet 🌀🏖️', par: 5, weather: 'rain', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [], sandTraps: [{ x: 230, y: 260, w: 140, h: 120, label: '🏖️ SAND' }, { x: 430, y: 120, w: 140, h: 120, label: '🏖️ SAND' }], waterHazards: [{ x: 340, y: 50, w: 140, h: 90, label: '🌊 WATER' }, { x: 340, y: 360, w: 140, h: 90, label: '🌊 WATER' }], icePatches: [], portals: [], windmills: [{ x: 260, y: 110, radius: 55, angle: 0, speed: 0.045, label: '🌀 WINDMILL A' }, { x: 410, y: 250, radius: 55, angle: Math.PI / 3, speed: -0.045, label: '🌀 WINDMILL B' }, { x: 560, y: 110, radius: 55, angle: Math.PI / 6, speed: 0.05, label: '🌀 WINDMILL C' }], slides: [] },
