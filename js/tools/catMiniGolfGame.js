...
const ALL_18_HOLES = [
  ...
  { name: 'Hole 17: Windmill Oasis Archipelago 🌴🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [{ x: 380, y: 220, w: 25, h: 120, label: '🧱 BUMPER' }], sandTraps: [{ x: 240, y: 280, w: 120, h: 120, label: '🏖️ SAND' }, { x: 580, y: 100, w: 120, h: 120, label: '🏖️ SAND' }], waterHazards: [{ x: 280, y: 50, w: 140, h: 150, label: '🌊 NORTH POND' }, { x: 450, y: 300, w: 140, h: 150, label: '🌊 SOUTH POND' }], icePatches: [], portals: [], windmills: [{ x: 420, y: 150, radius: 65, angle: 0, speed: 0.04, label: '🌀 OASIS WINDMILL' }], slides: [] },
  { name: 'Hole 18: Grand Finale - Windmill Championship 🏆🌀', par: 5, weather: 'night', ballStart: { x: 90, y: 420 }, holePos: { x: 710, y: 100 }, walls: [{ x: 260, y: 240, w: 280, h: 25, label: '🧱 MAZE WALL' }], sandTraps: [{ x: 120, y: 100, w: 110, h: 100, label: '🏖️ SAND' }, { x: 440, y: 290, w: 140, h: 120, label: '🏖️ SAND TRAP' }], waterHazards: [{ x: 480, y: 50, w: 160, h: 110, label: '🌊 WATER' }], icePatches: [{ x: 250, y: 50, w: 140, h: 140, label: '🧊 ICE' }], portals: [], windmills: [{ x: 480, y: 160, radius: 65, angle: 0, speed: -0.045, label: '🌀 FINALE WINDMILL' }], slides: [] }
];
