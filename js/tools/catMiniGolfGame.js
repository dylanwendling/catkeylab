...
const ALL_18_HOLES = [
  ...
  { name: 'Hole 14: Snowy Ice & Portal Run 🧊🌀', par: 5, weather: 'snow', ballStart: { x: 90, y: 100 }, holePos: { x: 710, y: 400 }, walls: [{ x: 320, y: 0, w: 30, h: 280, label: '🧱 WALL' }, { x: 520, y: 200, w: 30, h: 300, label: '🧱 WALL' }], sandTraps: [{ x: 120, y: 50, w: 170, h: 140, label: '❄️ SNOW BANK' }, { x: 570, y: 50, w: 110, h: 180, label: '❄️ SNOW BANK' }], waterHazards: [], icePatches: [{ x: 120, y: 220, w: 170, h: 180, label: '🧊 SLICK ICE' }, { x: 380, y: 80, w: 120, h: 200, label: '🧊 SLICK ICE' }], portals: [{ inX: 200, inY: 420, outX: 660, outY: 100, radius: 25, label: '🌀 PORTAL' }], windmills: [], slides: [] },
  ...
  { name: 'Hole 16: Triple Windmill Lagoon 🌀🌊', par: 5, weather: 'rain', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [{ x: 480, y: 180, w: 25, h: 140, label: '🧱 BUMPER' }], sandTraps: [{ x: 220, y: 250, w: 100, h: 100, label: '🏖️ SAND' }, { x: 510, y: 250, w: 100, h: 100, label: '🏖️ SAND' }], waterHazards: [{ x: 330, y: 50, w: 160, h: 120, label: '🌊 WATER' }, { x: 330, y: 330, w: 160, h: 120, label: '🌊 WATER' }], icePatches: [], portals: [], windmills: [{ x: 260, y: 130, radius: 55, angle: 0, speed: 0.045, label: '🌀 WINDMILL A' }, { x: 410, y: 370, radius: 55, angle: Math.PI / 3, speed: -0.045, label: '🌀 WINDMILL B' }, { x: 560, y: 130, radius: 55, angle: Math.PI / 6, speed: 0.05, label: '🌀 WINDMILL C' }], slides: [] },
  { name: 'Hole 17: Island Green & Portal Defense ⛳🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 120, y: 180, w: 100, h: 140, label: '🏖️ SAND' }, { x: 640, y: 300, w: 110, h: 110, label: '🏖️ SAND' }], waterHazards: [{ x: 250, y: 50, w: 350, h: 400, label: '🌊 WATER HAZARD (+1)' }], icePatches: [], portals: [{ inX: 180, inY: 250, outX: 710, outY: 150, radius: 25, label: '🌀 PORTAL' }], windmills: [{ x: 710, y: 100, radius: 55, angle: 0, speed: -0.045, label: '🌀 ISLAND WINDMILL' }], slides: [] },
  { name: 'Hole 18: Grand Finale - Championship Ultimate 🏆🌀', par: 5, weather: 'night', ballStart: { x: 90, y: 420 }, holePos: { x: 710, y: 100 }, walls: [{ x: 200, y: 200, w: 380, h: 25, label: '🧱 MAZE WALL' }], sandTraps: [{ x: 120, y: 100, w: 100, h: 100, label: '🏖️ SAND' }, { x: 440, y: 280, w: 120, h: 120, label: '🏖️ SAND TRAP' }], waterHazards: [{ x: 450, y: 50, w: 160, h: 120, label: '🌊 WATER' }], icePatches: [{ x: 250, y: 50, w: 120, h: 140, label: '🧊 ICE' }], portals: [{ inX: 120, inY: 280, outX: 680, outY: 380, radius: 25, label: '🌀 PORTAL' }], windmills: [{ x: 390, y: 330, radius: 65, angle: 0, speed: -0.045, label: '🌀 WINDMILL A' }, { x: 580, y: 180, radius: 60, angle: Math.PI / 4, speed: 0.045, label: '🌀 WINDMILL B' }], slides: [] }
];
