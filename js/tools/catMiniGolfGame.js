...
const ALL_18_HOLES = [
  ...
  { name: 'Hole 2: Bumper Alley 🧱', par: 3, weather: 'sun', ballStart: { x: 100, y: 250 }, holePos: { x: 700, y: 250 }, walls: [{ x: 380, y: 100, w: 35, h: 300, label: '🧱 BUMPER WALL' }], sandTraps: [{ x: 240, y: 180, w: 100, h: 140, label: '🏖️ SAND' }, { x: 450, y: 180, w: 100, h: 140, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 3: Sand Trap Bend & Windmill 🏖️🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 150 }, holePos: { x: 700, y: 380 }, walls: [], sandTraps: [{ x: 260, y: 240, w: 150, h: 160, label: '🏖️ SAND TRAP' }], waterHazards: [{ x: 280, y: 50, w: 200, h: 140, label: '🌊 WATER HAZARD (+1)' }], icePatches: [], portals: [], windmills: [{ x: 490, y: 310, radius: 65, angle: 0, speed: 0.035, label: '🌀 BEND WINDMILL' }], slides: [] },
  { name: 'Hole 4: Windmill Fairway 🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 250 }, holePos: { x: 720, y: 250 }, walls: [], sandTraps: [{ x: 280, y: 180, w: 140, h: 140, label: '🏖️ SAND TRAP' }, { x: 480, y: 180, w: 140, h: 140, label: '🏖️ SAND TRAP' }], waterHazards: [], icePatches: [], portals: [], windmills: [{ x: 380, y: 100, radius: 65, angle: 0, speed: 0.035, label: '🌀 WINDMILL A' }, { x: 480, y: 400, radius: 65, angle: Math.PI / 3, speed: -0.035, label: '🌀 WINDMILL B' }], slides: [] },
  { name: 'Hole 5: Water & Sand Crossing 🌊🏖️', par: 4, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 220, y: 100, w: 90, h: 300, label: '🏖️ SAND' }, { x: 490, y: 100, w: 90, h: 300, label: '🏖️ SAND' }], waterHazards: [{ x: 330, y: 100, w: 140, h: 300, label: '🌊 WATER HAZARD (+1)' }], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 6: Portal Jump 🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 120 }, holePos: { x: 700, y: 400 }, walls: [{ x: 260, y: 0, w: 30, h: 350, label: '🧱 BUMPER WALL' }], sandTraps: [{ x: 330, y: 300, w: 140, h: 140, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [{ inX: 180, inY: 400, outX: 620, outY: 120, radius: 25, label: '🌀 PORTAL' }], windmills: [], slides: [] },
  { name: 'Hole 7: Ice & Snow Run 🧊❄️', par: 4, weather: 'snow', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 180, y: 120, w: 70, h: 260, label: '❄️ SNOW BANK' }, { x: 550, y: 120, w: 70, h: 260, label: '❄️ SNOW BANK' }], waterHazards: [], icePatches: [{ x: 250, y: 120, w: 300, h: 260, label: '🧊 SLICK ICE' }], portals: [], windmills: [], slides: [] },
  { name: 'Hole 8: Double Bumper & Sand 🧱🏖️', par: 4, weather: 'sun', ballStart: { x: 100, y: 100 }, holePos: { x: 700, y: 400 }, walls: [{ x: 250, y: 0, w: 30, h: 320, label: '🧱 BUMPER WALL' }, { x: 500, y: 180, w: 30, h: 320, label: '🧱 BUMPER WALL' }], sandTraps: [{ x: 310, y: 100, w: 150, h: 120, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 9: Forest Fairway & Windmill 🌴🌀', par: 5, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 720, y: 400 }, walls: [], sandTraps: [{ x: 280, y: 260, w: 180, h: 180, label: '🏖️ SAND TRAP' }, { x: 480, y: 100, w: 160, h: 140, label: '🏖️ SAND TRAP' }], waterHazards: [{ x: 280, y: 50, w: 180, h: 160, label: '🌊 WATER' }], icePatches: [], portals: [{ inX: 180, inY: 420, outX: 630, outY: 100, radius: 25, label: '🌀 PORTAL' }], windmills: [{ x: 580, y: 320, radius: 65, angle: 0, speed: -0.04, label: '🌀 FOREST WINDMILL' }], slides: [] },
  ...
  { name: 'Hole 11: Narrow Water Bridge 🌉', par: 4, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 140, y: 180, w: 90, h: 140, label: '🏖️ SAND' }], waterHazards: [{ x: 250, y: 50, w: 300, h: 160, label: '🌊 WATER' }, { x: 250, y: 290, w: 300, h: 160, label: '🌊 WATER' }], icePatches: [], portals: [], windmills: [], slides: [] },
  ...
  { name: 'Hole 13: Twin Windmill Bumper Alley 🌀🧱', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [{ x: 390, y: 200, w: 30, h: 100, label: '🧱 BUMPER' }], sandTraps: [{ x: 260, y: 320, w: 110, h: 110, label: '🏖️ SAND' }, { x: 450, y: 70, w: 110, h: 110, label: '🏖️ SAND' }], waterHazards: [{ x: 300, y: 10, w: 80, h: 70, label: '🌊 WATER' }, { x: 440, y: 420, w: 80, h: 70, label: '🌊 WATER' }], icePatches: [], portals: [], windmills: [{ x: 300, y: 140, radius: 65, angle: 0, speed: 0.04, label: '🌀 WINDMILL 1' }, { x: 500, y: 360, radius: 65, angle: Math.PI / 4, speed: -0.04, label: '🌀 WINDMILL 2' }], slides: [] },
  { name: 'Hole 14: Snowy Ice Run 🧊❄️', par: 4, weather: 'snow', ballStart: { x: 90, y: 100 }, holePos: { x: 710, y: 400 }, walls: [{ x: 320, y: 0, w: 30, h: 280, label: '🧱 WALL' }, { x: 520, y: 200, w: 30, h: 300, label: '🧱 WALL' }], sandTraps: [{ x: 120, y: 50, w: 170, h: 140, label: '❄️ SNOW BANK' }, { x: 570, y: 50, w: 110, h: 180, label: '❄️ SNOW BANK' }], waterHazards: [], icePatches: [{ x: 120, y: 220, w: 170, h: 180, label: '🧊 SLICK ICE' }, { x: 380, y: 80, w: 120, h: 200, label: '🧊 SLICK ICE' }], portals: [], windmills: [], slides: [] },
  { name: 'Hole 15: Sand, Water & Windmill Gauntlet 🏖️🌊🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [{ x: 580, y: 180, w: 25, h: 140, label: '🧱 BUMPER' }], sandTraps: [{ x: 240, y: 80, w: 140, h: 140, label: '🏖️ SAND' }, { x: 440, y: 280, w: 140, h: 140, label: '🏖️ SAND' }], waterHazards: [{ x: 240, y: 280, w: 140, h: 140, label: '🌊 WATER (+1)' }, { x: 440, y: 80, w: 140, h: 140, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 400, y: 250, radius: 65, angle: 0, speed: 0.04, label: '🌀 MID WINDMILL' }], slides: [] },
  { name: 'Hole 16: Triple Windmill Gauntlet 🌀🏖️', par: 5, weather: 'rain', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [], sandTraps: [{ x: 230, y: 260, w: 140, h: 120, label: '🏖️ SAND' }, { x: 430, y: 40, w: 140, h: 80, label: '🏖️ SAND' }], waterHazards: [{ x: 340, y: 50, w: 140, h: 90, label: '🌊 WATER' }, { x: 340, y: 360, w: 140, h: 90, label: '🌊 WATER' }], icePatches: [], portals: [], windmills: [{ x: 430, y: 250, radius: 55, angle: 0, speed: -0.045, label: '🌀 CENTER GUARD' }, { x: 570, y: 160, radius: 55, angle: Math.PI / 3, speed: 0.045, label: '🌀 UPPER GUARD' }, { x: 570, y: 340, radius: 55, angle: Math.PI / 6, speed: -0.05, label: '🌀 LOWER GUARD' }], slides: [] },
  { name: 'Hole 17: Windmill Oasis Archipelago 🌴🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 240, y: 280, w: 120, h: 120, label: '🏖️ SAND' }, { x: 580, y: 100, w: 120, h: 120, label: '🏖️ SAND' }], waterHazards: [{ x: 280, y: 50, w: 140, h: 150, label: '🌊 NORTH POND' }, { x: 450, y: 300, w: 140, h: 150, label: '🌊 SOUTH POND' }], icePatches: [], portals: [], windmills: [{ x: 390, y: 220, radius: 65, angle: 0, speed: 0.04, label: '🌀 OASIS WINDMILL' }], slides: [] },
  { name: 'Hole 18: Grand Finale - Windmill Championship 🏆🌀', par: 5, weather: 'night', ballStart: { x: 90, y: 420 }, holePos: { x: 710, y: 100 }, walls: [{ x: 260, y: 240, w: 280, h: 25, label: '🧱 MAZE WALL' }], sandTraps: [{ x: 120, y: 100, w: 110, h: 100, label: '🏖️ SAND' }, { x: 440, y: 290, w: 130, h: 110, label: '🏖️ SAND TRAP' }], waterHazards: [{ x: 480, y: 50, w: 160, h: 110, label: '🌊 UPPER WATER' }, { x: 600, y: 340, w: 160, h: 120, label: '🌊 POCKET WATER' }], icePatches: [{ x: 250, y: 50, w: 140, h: 140, label: '🧊 ICE' }], portals: [], windmills: [{ x: 480, y: 160, radius: 65, angle: 0, speed: -0.045, label: '🌀 UPPER WINDMILL' }, { x: 330, y: 350, radius: 55, angle: Math.PI / 4, speed: 0.04, label: '🌀 LOWER WINDMILL' }], slides: [] }
];
