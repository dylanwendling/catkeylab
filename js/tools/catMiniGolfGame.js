...
const ALL_18_HOLES = [
  { name: 'Hole 1: Sunny Tee ☀️', par: 3, weather: 'sun', ballStart: { x: 100, y: 250 }, holePos: { x: 700, y: 250 }, walls: [], sandTraps: [{ x: 350, y: 140, w: 120, h: 100, label: '🏖️ SAND' }, { x: 350, y: 260, w: 120, h: 100, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 2: Bumper Alley 🧱', par: 3, weather: 'sun', ballStart: { x: 100, y: 250 }, holePos: { x: 700, y: 250 }, walls: [{ x: 380, y: 100, w: 35, h: 300, label: '🧱 WALL' }], sandTraps: [{ x: 240, y: 180, w: 100, h: 140, label: '🏖️ SAND' }, { x: 450, y: 180, w: 100, h: 140, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 3: Sand Trap Bend & Windmill 🏖️🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 150 }, holePos: { x: 700, y: 380 }, walls: [], sandTraps: [{ x: 260, y: 240, w: 150, h: 160, label: '🏖️ SAND' }], waterHazards: [{ x: 280, y: 50, w: 200, h: 140, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 490, y: 310, radius: 65, angle: 0, speed: 0.035, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 4: Windmill Fairway 🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 250 }, holePos: { x: 720, y: 250 }, walls: [], sandTraps: [{ x: 280, y: 180, w: 140, h: 140, label: '🏖️ SAND' }, { x: 480, y: 180, w: 140, h: 140, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [{ x: 380, y: 100, radius: 65, angle: 0, speed: 0.035, label: '🌀 WINDMILL' }, { x: 480, y: 400, radius: 65, angle: Math.PI / 3, speed: -0.035, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 5: Water & Sand Crossing 🌊🏖️', par: 4, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 220, y: 100, w: 90, h: 300, label: '🏖️ SAND' }, { x: 490, y: 100, w: 90, h: 300, label: '🏖️ SAND' }], waterHazards: [{ x: 330, y: 100, w: 140, h: 300, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 6: Portal Jump 🌀', par: 4, weather: 'sun', ballStart: { x: 100, y: 120 }, holePos: { x: 700, y: 400 }, walls: [{ x: 260, y: 0, w: 30, h: 350, label: '🧱 WALL' }], sandTraps: [{ x: 330, y: 300, w: 140, h: 140, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [{ inX: 180, inY: 400, outX: 620, outY: 120, radius: 25, label: '🌀 PORTAL' }], windmills: [], slides: [] },
  { name: 'Hole 7: Ice & Snow Run 🧊❄️', par: 4, weather: 'snow', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 180, y: 120, w: 70, h: 260, label: '❄️ SNOW' }, { x: 550, y: 120, w: 70, h: 260, label: '❄️ SNOW' }], waterHazards: [], icePatches: [{ x: 250, y: 120, w: 300, h: 260, label: '🧊 ICE' }], portals: [], windmills: [], slides: [] },
  { name: 'Hole 8: Double Bumper & Sand 🧱🏖️', par: 4, weather: 'sun', ballStart: { x: 100, y: 100 }, holePos: { x: 700, y: 400 }, walls: [{ x: 250, y: 0, w: 30, h: 320, label: '🧱 WALL' }, { x: 500, y: 180, w: 30, h: 320, label: '🧱 WALL' }], sandTraps: [{ x: 310, y: 100, w: 150, h: 120, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 9: Forest Fairway & Windmill 🌴🌀', par: 5, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 720, y: 400 }, walls: [], sandTraps: [{ x: 280, y: 260, w: 180, h: 180, label: '🏖️ SAND' }, { x: 480, y: 100, w: 160, h: 140, label: '🏖️ SAND' }], waterHazards: [{ x: 280, y: 50, w: 180, h: 160, label: '🌊 WATER (+1)' }], icePatches: [], portals: [{ inX: 180, inY: 420, outX: 630, outY: 100, radius: 25, label: '🌀 PORTAL' }], windmills: [{ x: 580, y: 320, radius: 65, angle: 0, speed: -0.04, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 10: Rainy Slalom 🌧️', par: 4, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 700, y: 250 }, walls: [{ x: 300, y: 100, w: 30, h: 180, label: '🧱 WALL' }, { x: 500, y: 220, w: 30, h: 180, label: '🧱 WALL' }], sandTraps: [{ x: 380, y: 150, w: 100, h: 200, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 11: Narrow Water Bridge 🌉', par: 4, weather: 'rain', ballStart: { x: 100, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 140, y: 180, w: 90, h: 140, label: '🏖️ SAND' }], waterHazards: [{ x: 250, y: 50, w: 300, h: 160, label: '🌊 WATER (+1)' }, { x: 250, y: 290, w: 300, h: 160, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [], slides: [] },
  { name: 'Hole 12: Portal Maze 🌀', par: 4, weather: 'night', ballStart: { x: 90, y: 400 }, holePos: { x: 710, y: 100 }, walls: [{ x: 200, y: 150, w: 400, h: 30, label: '🧱 WALL' }, { x: 400, y: 300, w: 30, h: 180, label: '🧱 WALL' }], sandTraps: [{ x: 240, y: 200, w: 140, h: 80, label: '🏖️ SAND' }], waterHazards: [], icePatches: [], portals: [{ inX: 140, inY: 100, outX: 680, outY: 400, radius: 25, label: '🌀 PORTAL' }], windmills: [], slides: [] },
  { name: 'Hole 13: Twin Windmill Bumper Alley 🌀🧱', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [{ x: 390, y: 200, w: 30, h: 100, label: '🧱 WALL' }], sandTraps: [{ x: 260, y: 320, w: 110, h: 110, label: '🏖️ SAND' }, { x: 450, y: 70, w: 110, h: 110, label: '🏖️ SAND' }], waterHazards: [{ x: 300, y: 10, w: 80, h: 70, label: '🌊 WATER (+1)' }, { x: 440, y: 420, w: 80, h: 70, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 300, y: 140, radius: 65, angle: 0, speed: 0.04, label: '🌀 WINDMILL' }, { x: 500, y: 360, radius: 65, angle: Math.PI / 4, speed: -0.04, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 14: Snowy Ice Run 🧊❄️', par: 4, weather: 'snow', ballStart: { x: 90, y: 100 }, holePos: { x: 710, y: 400 }, walls: [{ x: 320, y: 0, w: 30, h: 280, label: '🧱 WALL' }, { x: 520, y: 200, w: 30, h: 300, label: '🧱 WALL' }], sandTraps: [{ x: 120, y: 50, w: 170, h: 140, label: '❄️ SNOW' }, { x: 570, y: 50, w: 110, h: 180, label: '❄️ SNOW' }], waterHazards: [], icePatches: [{ x: 120, y: 220, w: 170, h: 180, label: '🧊 ICE' }, { x: 380, y: 80, w: 120, h: 200, label: '🧊 ICE' }], portals: [], windmills: [], slides: [] },
  { name: 'Hole 15: Sand, Water & Windmill Gauntlet 🏖️🌊🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [{ x: 580, y: 180, w: 25, h: 140, label: '🧱 WALL' }], sandTraps: [{ x: 240, y: 80, w: 140, h: 140, label: '🏖️ SAND' }, { x: 440, y: 280, w: 140, h: 140, label: '🏖️ SAND' }], waterHazards: [{ x: 240, y: 280, w: 140, h: 140, label: '🌊 WATER (+1)' }, { x: 440, y: 80, w: 140, h: 140, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 400, y: 250, radius: 65, angle: 0, speed: 0.04, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 16: Triple Windmill Gauntlet 🌀🏖️', par: 5, weather: 'rain', ballStart: { x: 90, y: 250 }, holePos: { x: 720, y: 250 }, walls: [], sandTraps: [{ x: 250, y: 40, w: 120, h: 80, label: '🏖️ SAND' }, { x: 230, y: 350, w: 120, h: 90, label: '🏖️ SAND' }], waterHazards: [{ x: 410, y: 40, w: 130, h: 80, label: '🌊 WATER (+1)' }, { x: 390, y: 360, w: 130, h: 80, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 430, y: 250, radius: 55, angle: 0, speed: -0.045, label: '🌀 WINDMILL' }, { x: 570, y: 160, radius: 55, angle: Math.PI / 3, speed: 0.045, label: '🌀 WINDMILL' }, { x: 570, y: 340, radius: 55, angle: Math.PI / 6, speed: -0.05, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 17: Windmill Oasis Archipelago 🌴🌀', par: 5, weather: 'sun', ballStart: { x: 90, y: 250 }, holePos: { x: 710, y: 250 }, walls: [], sandTraps: [{ x: 240, y: 280, w: 120, h: 120, label: '🏖️ SAND' }, { x: 580, y: 100, w: 120, h: 120, label: '🏖️ SAND' }], waterHazards: [{ x: 280, y: 50, w: 140, h: 150, label: '🌊 WATER (+1)' }, { x: 450, y: 300, w: 140, h: 150, label: '🌊 WATER (+1)' }], icePatches: [], portals: [], windmills: [{ x: 390, y: 220, radius: 65, angle: 0, speed: 0.04, label: '🌀 WINDMILL' }], slides: [] },
  { name: 'Hole 18: Grand Finale - Windmill Championship 🏆🌀', par: 5, weather: 'night', ballStart: { x: 90, y: 420 }, holePos: { x: 710, y: 100 }, walls: [{ x: 260, y: 240, w: 280, h: 25, label: '🧱 WALL' }], sandTraps: [{ x: 120, y: 100, w: 110, h: 100, label: '🏖️ SAND' }, { x: 440, y: 290, w: 130, h: 110, label: '🏖️ SAND' }], waterHazards: [{ x: 480, y: 50, w: 160, h: 110, label: '🌊 WATER (+1)' }, { x: 600, y: 340, w: 160, h: 120, label: '🌊 WATER (+1)' }], icePatches: [{ x: 250, y: 50, w: 140, h: 140, label: '🧊 ICE' }], portals: [], windmills: [{ x: 480, y: 160, radius: 65, angle: 0, speed: -0.045, label: '🌀 WINDMILL' }, { x: 330, y: 350, radius: 55, angle: Math.PI / 4, speed: 0.04, label: '🌀 WINDMILL' }], slides: [] }
];
