  ...
  container.innerHTML = `
    ${isMobile ? `
      <div style="background:var(--bg-secondary); border:1px solid var(--accent-amber); padding:1.5rem; border-radius:var(--radius-lg); text-align:center; margin-bottom:1.5rem; box-shadow:var(--shadow-md);">
        ...
        <p style="color:var(--text-secondary); font-size:0.9rem; margin-bottom:1.25rem;">104-key rollover & physical mechanical keyboard testing requires a desktop computer with a physical keyboard attached.</p>
        <div style="display:flex; gap:0.5rem; justify-content:center; flex-wrap:wrap;">
          <a href="#typing-test" class="btn btn-primary btn-sm">⌨️ Try Mobile Typing Test</a>
          <a href="#cps-test" class="btn btn-secondary btn-sm">⚡ Try Mobile CPS Test</a>
